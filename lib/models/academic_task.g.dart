...
AcademicTask _academicTaskDeserialize(
  ...
  final object = AcademicTask(
    ...
    type: reader.readStringOrNull(offsets[5]) ?? 'Assignment',
  );
  object.id = id;
  return object;
}
...
P _academicTaskDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (reader.readStringOrNull(offset) ?? '') as P;
    case 5:
      return (reader.readStringOrNull(offset) ?? 'Assignment') as P;
    default:
...
extension AcademicTaskQuerySortBy
  ...
  QueryBuilder<AcademicTask, AcademicTask, QAfterSortBy> sortByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AcademicTask, AcademicTask, QAfterSortBy> sortBySubject() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subject', Sort.asc);
    });
  }

  QueryBuilder<AcademicTask, AcademicTask, QAfterSortBy> sortBySubjectDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AcademicTaskQuerySortThenBy
  ...
  QueryBuilder<AcademicTask, AcademicTask, QAfterSortBy> thenByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCompleted', Sort.asc);
    });
  }
  ...
  QueryBuilder<AcademicTask, AcademicTask, QAfterSortBy> thenBySubject() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subject', Sort.asc);
    });
  }

  QueryBuilder<AcademicTask, AcademicTask, QAfterSortBy> thenBySubjectDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'subject', Sort.desc);
    });
  }
...
extension AcademicTaskQueryWhereDistinct
  ...
  QueryBuilder<AcademicTask, AcademicTask, QDistinct> distinctByIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isCompleted');
    });
  }

  QueryBuilder<AcademicTask, AcademicTask, QDistinct> distinctBySubject(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AcademicTaskQueryProperty
  ...
  QueryBuilder<AcademicTask, bool, QQueryOperations> isCompletedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isCompleted');
    });
  }

  QueryBuilder<AcademicTask, String, QQueryOperations> subjectProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AcademicTask, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
